...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        def retrieve_input():
            ...
            newpath = r'/home/puneet/attendanceSystem/Images'
            newpath = newpath + '/'
        ...
        button2 = tk.Button(self, text="Submit", command=lambda: retrieve_input()).grid(row=3, column=3, padx=10,
                                                                                        pady=10)
                        ...
                        for face_encoding in face_encodings:
                            ...
                            for fileName in folders:
                                ...
                                for everyFile in files:
                                    # print(everyFile)
                                    eImage = face_recognition.load_image_file(
                                        os.path.join(os.path.join(pathN, fileName), everyFile))
